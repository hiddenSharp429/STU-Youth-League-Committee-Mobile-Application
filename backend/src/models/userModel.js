 ...
 * @LastEditTime: 2024-09-27 14:50:23
...
class UserModel {
  ...
  static async createUser(account, password, name, type) {
    const [result] = await db.execute(
      'INSERT INTO users (account, password, name, type) VALUES (?, ?, ?, ?)',
      [account, password, name, type]
    );
    return { id: result.insertId, account, name, type };
  }
